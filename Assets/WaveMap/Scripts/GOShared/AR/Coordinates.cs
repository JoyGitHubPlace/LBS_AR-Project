...
namespace GoShared {
	...
	public class Coordinates {
		...
		public Coordinates (double latitude, double longitude, double altitude){
            //Debug.Log("Coordinates (double latitude, double longitude, double altitude)");
		...
		public Coordinates (LocationInfo location){
            //Debug.Log("Coordinates (LocationInfo location)");
		...
		public Coordinates (Vector2 tileCoords,int zoom){
           // Debug.Log("Coordinates (Vector2 tileCoords,int zoom)");
