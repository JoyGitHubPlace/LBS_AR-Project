...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	/// 	{
	/// 		using ( ZipInputStreamM s = new ZipInputStreamM(File.OpenRead(args[0]))) {
	///
	/// 			ZipEntryM theEntry;
	/// 			const int size = 2048;
	...
	/// </code>
	/// </example>
	public class ZipInputStreamM : InflaterInputStream
	{
		...
		public ZipInputStreamM(Stream baseInputStream)
		...
		public ZipInputStreamM(Stream baseInputStream, int bufferSize)
		...
		/// </summary>
		/// <value>A password for all encrypted <see cref="ZipEntryM">entries </see> in this <see cref="ZipInputStreamM"/></value>
		...
		/// See the <see cref="ZipEntryM.Version">ZipEntryM Version</see> property for more details.
		/// </remarks>
		...
		public override int Read(byte[] buffer, int offset, int count)
		{
			...
			if (offset < 0) {
				//throw new //nameofnameof//(offset), "Cannot be negative");
			}

			if (count < 0) {
				//throw new //nameofnameof//(count), "Cannot be negative");
			}
