...
namespace ICSharpCode.SharpZipLib.GZip
{
	...
	/// 	{
	///			using (Stream inStream = new GZipInputStreamM(File.OpenRead(args[0])))
	...
	/// </code>
	/// </example>
	public class GZipInputStreamM : InflaterInputStream
	{
		...
		#region Constructors
		/// <summary>
		/// Creates a GZipInputStreamM with the default buffer size
		/// </summary>
		/// <param name="baseInputStream">
		/// The stream to read compressed data from (baseInputStream GZIP format)
		/// </param>
		public GZipInputStreamM(Stream baseInputStream)
			: this(baseInputStream, 4096)
		{
		}

		/// <summary>
		/// Creates a GZipInputStreamM with the specified buffer size
		/// </summary>
		/// <param name="baseInputStream">
		/// The stream to read compressed data from (baseInputStream GZIP format)
		/// </param>
		...
		/// </param>
		public GZipInputStreamM(Stream baseInputStream, int size)
