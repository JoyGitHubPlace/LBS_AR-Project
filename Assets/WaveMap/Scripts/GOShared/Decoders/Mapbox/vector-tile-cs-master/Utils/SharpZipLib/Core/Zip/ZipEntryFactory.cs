...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	/// </summary>
	public class ZipEntryMFactory : IEntryFactory
	{
		#region Enumerations
		/// <summary>
		/// Defines the possible values to be used for the <see cref="ZipEntryM.DateTime"/>.
		/// </summary>
		public enum TimeSetting
		{
			...
			/// specified via the <see cref="ZipEntryMFactory(DateTime)"/> constructor or 
			/// using the <see cref="ZipEntryMFactory(TimeSetting)"/> with the setting set
		...
		#region Constructors
		/// <summary>
		/// Initialise a new instance of the <see cref="ZipEntryMFactory"/> class.
		/// </summary>
		/// <remarks>A default <see cref="INameTransform"/>, and the LastWriteTime for files is used.</remarks>
		public ZipEntryMFactory()
		{
			nameTransform_ = new ZipNameTransform();
		}

		/// <summary>
		/// Initialise a new instance of <see cref="ZipEntryMFactory"/> using the specified <see cref="TimeSetting"/>
		/// </summary>
		/// <param name="timeSetting">The <see cref="TimeSetting">time setting</see> to use when creating <see cref="ZipEntryM">Zip entries</see>.</param>
		public ZipEntryMFactory(TimeSetting timeSetting)
		{
		...
		/// <summary>
		/// Initialise a new instance of <see cref="ZipEntryMFactory"/> using the specified <see cref="DateTime"/>
		/// </summary>
		/// <param name="time">The time to set all <see cref="ZipEntryM.DateTime"/> values to.</param>
		public ZipEntryMFactory(DateTime time)
		{
		...
		#region Properties
		/// <summary>
		/// Get / set the <see cref="INameTransform"/> to be used when creating new <see cref="ZipEntryM"/> values.
		/// </summary>
		/// <remarks>
		...
		/// <returns>Returns a new <see cref="ZipEntryM"/> based on the <paramref name="fileName"/>.</returns>
		public ZipEntryM MakeFileEntry(string fileName, bool useFileSystem)
		{
...
//					default:
		...
		public ZipEntryM MakeDirectoryEntry(string directoryName)
		{
