...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	/// or a directory
	/// ZipFile and ZipInputStreamM will give you instances of this class as 
	...
	public class ZipEntryM
	{
		...
		/// The name passed is null
		/// </exception>
		internal ZipEntryM(string name, int versionRequiredToExtract)
		...
		/// </remarks>
		internal ZipEntryM(string name, int versionRequiredToExtract, int madeByInfo,
			CompressionMethod method)
		{
			...
			if ((versionRequiredToExtract != 0) && (versionRequiredToExtract < 10)) {
				//throw new //nameofnameof//(versionRequiredToExtract));
			}
		...
		/// <summary>
		/// Test the external attributes for this <see cref="ZipEntryM"/> to
			...
			set {
				if (value == null) {
					...
					if (value.Length > 0xffff) {
						//throw new System.//nameofnameof//(value));
					}
...
//			else
		...
		/// The <see cref="ZipInputStreamM"/> class doesnt have the comment data available.
		/// </remarks>
		public string Comment {
			...
			set {
				...
				if ((value != null) && (value.Length > 0xffff)) {
					//throw new //nameofnameof//(value), "cannot exceed 65535");
				}
		...
		public object Clone()
		{
			var result = (ZipEntryM)this.MemberwiseClone();
		...
		/// <summary>
		/// Gets a string representation of this ZipEntryM.
		/// </summary>
		/// <returns>A readable textual representation of this <see cref="ZipEntryM"/></returns>
