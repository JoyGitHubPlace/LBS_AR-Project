...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	/// 				ZipEntryM entry = new ZipEntryM(file);
	...
	public class ZipOutputStream : DeflaterOutputStream
	{
		...
		/// If backwards compatability is an issue be careful when adding <see cref="ZipEntryM.Size">entries</see> to an archive.
...
//				//throw new //nameofnameof//(count), "Cannot be negative");
		...
		/// </summary>
		List<ZipEntryM> entries = new List<ZipEntryM>();
